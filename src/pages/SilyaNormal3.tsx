...
import Silya_Normal_3_tmpt from "@/assets/Silya_Normal_3+1_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const SilyaNormal3 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Silya_Normal_3_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Silya Normal 3+1 Template"
