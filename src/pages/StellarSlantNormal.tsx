...
import Stellar_Slant_Normal_tmpt from "@/assets/Stellar_Slant_Normal_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const StellarSlantNormal = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Stellar_Slant_Normal_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Stellar Slant Normal Template"
...
export default StellarSlantNormal;
