...
import Stellar_Slant_Hot_tmpt from "@/assets/Stellar_Slant_Hot_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const StellarSlantHot = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Stellar_Slant_Hot_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Stellar Slant Hot Template"
...
export default StellarSlantHot;
