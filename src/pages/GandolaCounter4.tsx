...
import Gandola_Counter4_tmpt from "@/assets/Gandola_Counter4_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const GandolaCounter4 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Gandola_Counter4_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Gandola Counter4 Template"
...
export default GandolaCounter4;
