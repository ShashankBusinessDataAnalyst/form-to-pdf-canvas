...
import Steffania_Prima_Hot_tmpt from "@/assets/Steffania_Prima_Hot_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.


const SteffaniaPrimaHot = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Steffania_Prima_Hot_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Steffania Prima Hot Template"
...
export default SteffaniaPrimaHot;
