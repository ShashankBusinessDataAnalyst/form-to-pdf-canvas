...
import Slavia_Normal_tmpt from "@/assets/Slavia_Normal_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const SlaviaNormal = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Slavia_Normal_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Slavia Normal Template"
