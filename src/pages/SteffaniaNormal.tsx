...
import Steffania_Normal_tmpt from "@/assets/Steffania_Normal_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.



const SteffaniaNormal = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Steffania_Normal_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Steffania Normal Template"
...
export default SteffaniaNormal;
