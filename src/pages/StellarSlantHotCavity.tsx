...
import Stellar_Slant_Hot_Cavity_tmpt from "@/assets/Stellar_Slant_Hot_Cavity_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const StellarSlantHotCavity = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Stellar_Slant_Hot_Cavity_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Stellar Slant Hot Cavity Template"
...
export default StellarSlantHotCavity;
