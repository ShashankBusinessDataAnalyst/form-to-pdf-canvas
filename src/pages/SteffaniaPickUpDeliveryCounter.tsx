...
import Steffania_PickUp_and_Delivery_Counter_tmpt from "@/assets/Steffania_PickUp_and_Delivery_Counter_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const SteffaniaPickUpDeliveryCounter = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Steffania_PickUp_and_Delivery_Counter_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Steffania PickUp and Delivery Counter Template"
...
export default SteffaniaPickUpDeliveryCounter;
