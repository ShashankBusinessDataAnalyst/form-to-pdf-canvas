...
import Shannon_Low_Base_Hot_Cavity_tmpt from "@/assets/Shannon_Low_Base_Hot_Cavity_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const ShannonLowBaseHotCavity = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shannon_Low_Base_Hot_Cavity_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shannon Low Base Hot Cavity Template"
...
export default ShannonLowBaseHotCavity;
