...
import Stellar_Spire_Cold_tmpt from "@/assets/Stellar_Spire_Cold_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const Stellar_Spire_Cold = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Stellar_Spire_Cold_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Stellar Sprire Cold Template"
...
export default Stellar_Spire_Cold;
