...
import Slavia_Hot_Cavity_tmpt from "@/assets/Slavia_Hot_Cavity_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const SlaviaHotCavity = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Slavia_Hot_Cavity_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Slavia Hot CavityTemplate"
...
export default SlaviaHotCavity;
