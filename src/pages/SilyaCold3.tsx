...
import Silya_Cold_3_tmpt from "@/assets/Silya_Cold_3+1_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const SilyaCold3 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Silya_Cold_3_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Silya Cold 3+1 Template"
