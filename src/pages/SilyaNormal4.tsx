...
import Silya_Normal_4_tmpt from "@/assets/Silya_Normal_4+1_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const SilyaNormal4 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Silya_Normal_4_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Silya Normal 4+1 Template"
