...
import Slavia_PickUp_and_Delivery_Counter_tmpt from "@/assets/Slavia_PickUp_and_Delivery_Counter_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const SlaviaPickUpDeliveryCounter = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Slavia_PickUp_and_Delivery_Counter_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Slavia PickUp and Delivery Counter Template"
...
export default SlaviaPickUpDeliveryCounter;
