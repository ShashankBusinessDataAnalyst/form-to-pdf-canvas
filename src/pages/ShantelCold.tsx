...
import Shantel_Cold_tmpt from "@/assets/Shantel_Cold_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const ShantelCold = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shantel_Cold_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shantel Cold Template"
