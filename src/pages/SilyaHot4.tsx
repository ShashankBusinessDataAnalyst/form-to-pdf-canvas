...
import Silya_Hot_4_tmpt from "@/assets/Silya_Hot_4+1_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const SilyaHot4 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Silya_Hot_4_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Silya Hot 4+1 Template"
