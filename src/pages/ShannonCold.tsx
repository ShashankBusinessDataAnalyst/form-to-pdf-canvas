...
import Shannon_Cold_tmpt from "@/assets/Shannon_Cold_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const ShannonCold = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shannon_Cold_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shannon Cold Template"
