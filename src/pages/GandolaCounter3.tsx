...
import Gandola_Counter3_tmpt from "@/assets/Gandola_Counter3_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const GandolaCounter3 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Gandola_Counter3_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Gandola Counter3 Template"
...
export default GandolaCounter3;
