...
import Steffania_Hot_tmpt from "@/assets/Steffania_Hot_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const SteffaniaHot = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Steffania_Hot_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Steffania Hot Template"
