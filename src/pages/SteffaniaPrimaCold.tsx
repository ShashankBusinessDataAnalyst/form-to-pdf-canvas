...
import Steffania_Prima_Cold_tmpt from "@/assets/Steffania_Prima_Cold_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const SteffaniaPrimaCold = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Steffania_Prima_Cold_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Steffania Prima Cold Template"
...
export default SteffaniaPrimaCold;
