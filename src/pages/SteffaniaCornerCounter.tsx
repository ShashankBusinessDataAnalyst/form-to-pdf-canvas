...
import Steffania_Corner_Counter_tmpt from "@/assets/Steffania_Corner_Counter_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const SteffaniaCornerCounter = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Steffania_Corner_Counter_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Steffania Corner Counter Template"
      ...
      >
        ...
        <FormTextInput
          ...
          onChange={(val) => handleFieldChange("Reference", val)}
          position={{ top: 403, left: 980 }}
          width={100}
          placeholder="Add Text"
        />
        <FormTextarea
...
export default SteffaniaCornerCounter;
