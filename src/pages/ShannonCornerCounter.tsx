...
import Shannon_Corner_Counter_tmpt from "@/assets/Shannon_Corner_Counter_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const ShannonCornerCounter = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shannon_Corner_Counter_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shannon Corner Counter Template"
...
export default ShannonCornerCounter;
