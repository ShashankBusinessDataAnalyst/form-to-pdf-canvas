...
import Gandola_Counter1_tmpt from "@/assets/Gandola_Counter1_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const GandolaCounter1 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Gandola_Counter1_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Gandola Counter1 Template"
...
export default GandolaCounter1;
