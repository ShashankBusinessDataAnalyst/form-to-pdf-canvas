...
import Shantel_Hot_tmpt from "@/assets/Shantel_Hot_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const ShantelHot = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shantel_Hot_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shantel Hot Template"
