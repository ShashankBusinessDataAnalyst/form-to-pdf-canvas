...
import Steffania_Cold_tmpt from "@/assets/Steffania_Cold_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const SteffaniaCold = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Steffania_Cold_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Steffania Cold Template"
