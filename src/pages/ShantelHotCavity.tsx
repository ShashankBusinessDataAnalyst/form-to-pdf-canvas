...
import Shantel_Hot_Cavity_tmpt from "@/assets/Shantel_Hot_Cavity_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const ShantelHotCavity = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shantel_Hot_Cavity_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shantel Hot Cavity Template"
...
export default ShantelHotCavity;
