...
import Shannon_Hot_tmpt from "@/assets/Shannon_Hot_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const ShannonHot = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shannon_Hot_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shannon Hot Template"
