...
import Gift_Rack2_tmpt from "@/assets/Gift_Rack2_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const GiftRack2 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Gift_Rack2_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Gift Rack 2 Template"
