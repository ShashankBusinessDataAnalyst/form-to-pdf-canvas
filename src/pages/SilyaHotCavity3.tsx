...
import Silya_Hot_Cavity_3_tmpt from "@/assets/Silya_Hot_Cavity_3+1_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const SilyaHotCavity3 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Silya_Hot_Cavity_3_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Silya Hot Cavity 3+1 Template"
...
export default SilyaHotCavity3;
