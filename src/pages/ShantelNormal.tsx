...
import Shantel_Normal_tmpt from "@/assets/Shantel_Normal_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const ShantelNormal = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shantel_Normal_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shantel Normal Template"
