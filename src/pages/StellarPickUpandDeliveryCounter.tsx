...
import Stellar_PickUp_and_Delivery_Counter_tmpt from "@/assets/Stellar_PickUp_and_Delivery_Counter_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const StellarPickUpandDeliveryCounter = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Stellar_PickUp_and_Delivery_Counter_tmpt} //Background image of the template.The png file should be of high quality.
...
export default StellarPickUpandDeliveryCounter;
