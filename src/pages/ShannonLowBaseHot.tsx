...
import Shannon_Low_Base_Hot_tmpt from "@/assets/Shannon_Low_Base_Hot_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const ShannonLowBaseHot = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Shannon_Low_Base_Hot_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Shannon Low Base Hot Template"
...
export default ShannonLowBaseHot;
