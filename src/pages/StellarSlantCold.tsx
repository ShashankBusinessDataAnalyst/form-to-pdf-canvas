...
import Stellar_Slant_Cold_tmpt from "@/assets/Stellar_Slant_Cold_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.

const StellarSlantCold = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Stellar_Slant_Cold_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Stellar Slant Cold Template"
...
export default StellarSlantCold;
