...
import Implus_Rack_tmpt from "@/assets/Implus_Rack_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const ImplusRack = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Implus_Rack_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Implus Rack Template"
