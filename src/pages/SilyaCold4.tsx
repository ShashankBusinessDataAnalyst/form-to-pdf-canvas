...
import Silya_Cold_4_tmpt from "@/assets/Silya_Cold_4+1_tmpt.png"; //Make sure the file name matches the actual template background file in assets folder.
...
const SilyaCold4 = () => {
  ...
  return (
    <PrintModeProvider>
      <TemplateEditor
        templateImage={Silya_Cold_4_tmpt} //Background image of the template.The png file should be of high quality.
        templateName="Silya Cold 4+1 Template"
